...
| Nuova routine | proposta visuale del flusso rapido e della configurazione progressiva, con collegamenti comprensibili | composizione 3 del passaggio minimo scelta e corretta senza duplicare l’obiettivo; composizione 3 di «Cosa succede dopo» approvata con scala standard e correzione degli a capo; [vincoli](creation-flow.md#proposta-visuale-trama--dg-visual) |
