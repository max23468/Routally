...
| TG-DATA | Spike SwiftData/CloudKit | Decision Gate — Adapt candidato | 0.1 | Le evidenze locali sono positive, ma non sostituiscono sincronizzazione, recovery e schema su un container CloudKit provvisorio | Blocca E05 finché le prove CloudKit reali non sono concluse; schema Production definitivo in E21 | — |
