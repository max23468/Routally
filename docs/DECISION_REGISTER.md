...
| ADR-0008 | Schema locale V1 e confine transazionale dello store | Confirmed | 0.2 | Collegare il dominio E04 a SwiftData senza esporre il framework o persistere stato derivato | Actor dedicato, UUID scalari, payload di dominio, deduplica applicativa e singolo salvataggio dopo il ricalcolo | 2026-08-27 |
