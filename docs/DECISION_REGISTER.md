...
| ADR-0005 | La review delle pull request è un gate di CI | Superseded | 1.0 | Il gate Codex è stato rimosso dalla governance GitHub | Restano i gate CI e di pubblicazione non Codex | 2026-08-28 |
...
| ADR-0007 | Pubblicazione proporzionata con gate aggregato | Confirmed | 0.2 | Ridurre attese e duplicazioni senza indebolire l'evidenza sull'HEAD | Classificazione condivisa, gate paralleli, status trusted, auto-merge e verifica del tree | 2026-08-27 |
| ADR-0008 | Schema locale V1, payload V2 e confine transazionale dello store | Confirmed | 0.3 | Collegare il dominio E04 a SwiftData senza esporre il framework o persistere stato derivato | Actor dedicato, UUID scalari, payload versionato, reset pre-release non distruttivo, deduplica applicativa e singolo salvataggio dopo il ricalcolo | 2026-08-27 |
| ADR-0009 | Integrazione applicativa della vertical slice | Confirmed | 0.3 | Eliminare la doppia implementazione delle regole fra UI, dominio e persistenza | Modello di feature asincrono, eventi e revisioni reali, fallback a orario locale e confini testabili per reminder/location | 2026-08-27 |
...
| TG-DATA | Spike SwiftData/CloudKit | Confirmed — Adapt | 0.1 | Evidenze locali positive su store, convergenza, migrazioni, offline, recovery e dataset; la prova del servizio non è necessaria per scegliere l'architettura | Sblocca E05 con UUID e deduplica applicativi; integrazione locale in E14/M06, validazione CloudKit Development reale in M10 dopo DG-DEVELOPER-IDENTITY, Production in E21/M11 | 2026-08-23 |
| TG-RECALC | Spike sul ricalcolo retroattivo deterministico | Confirmed — Async boundary | 0.2 | Il dataset canonico converge, propaga solo le dipendenze e richiede un confine cancellabile fuori dal MainActor | Reducer puro sincrono; ricalcolo applicativo asincrono con risultato atomico, senza proiezioni persistenti | 2026-08-26 |
...
| DG-VISUAL | Trama, linguaggio visuale della vertical slice | Confirmed | 0.3 | Chiuso il 5 settembre 2026: fase 1 `92f97de` e pacchetto complessivo `1119333` approvati dal Product Owner; sei requisiti della sezione 48.3 soddisfatti | Soddisfa il prerequisito visuale; non avvia E07–E11 né certifica device reali, accessibilità completa o pubblicazione | [Revisione approvata](DESIGN/design-review.md) |
