# Routally — Master Plan precedente (archiviato)

> **Archivio storico, non implementare.** La fonte canonica attiva è
> [`docs/MASTER_PLAN.md`](../MASTER_PLAN.md). Le funzioni rinviate sono ricollocate nella
> [`roadmap 1.1+`](../PRODUCT/ROADMAP.md).

- **Documento canonico al momento dell'archiviazione:** `docs/MASTER_PLAN.md`
